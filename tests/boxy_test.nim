...
window.onFrame = proc() =
  ...
  for y in 0 ..< image.height:
    for x in 0 ..< image.width:
      pearl = (0xff and floor(256 * (perlinGradientOctaves(x.float64 / (1080.0'f64 / 16.0'f64), y.float64 / (1080.0'f64 / 16.0'f64), z, octaves = 8, persistence = 0.5'f64))[0] / 2 + 0.5).uint8)
